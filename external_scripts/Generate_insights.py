...
sql_file_path = "/opt/airflow/external_scripts/Sql_Analysis/monthly_insights.sql"
output_excel_file = f"/opt/airflow/reports/{month.capitalize()}_{year}_REPORT.xlsx"
